...
<body class="pt-5 mt-5">
    ...
    <div>
        <H2 class="text-center">All Announcements</H2>
        <table class="table">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    $row = '<tr>
                                ...
                                <td>' . $announcementJobType . ' </td>
                                <td>' . $announcementLocation . ' </td>
                                <td>' . $announcementEmployer . ' </td>
                                <td>' . $announcementAdditionalInfo . ' </td>
                                <td>' . $announcementURL . ' </td>
                            </tr>
                        ';
                    echo $row;
                }
